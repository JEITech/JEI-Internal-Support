...
define('SECRET_SALT','zHr0HOGoVVNx3oysKUHt7LeOLg6RJrfo');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','chris@meesewebdesigns.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','mysqlcluster25');
define('DBNAME','techsupport');
define('DBUSER','internalsupport');
define('DBPASS','coolFuckingpw1');
